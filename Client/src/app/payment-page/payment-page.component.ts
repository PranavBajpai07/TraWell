...
export class PaymentPageComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.finalDetails = this.paymentService.finalDetails;//to check in service that the value is there
 
    if(this.finalDetails == undefined){//to check if it is undefined in the service
    ...
    this.userService.userStatussObs.subscribe((data) => {//check if the data changes from true to false or vice versa
